...
exports.auctionPlayerPaginationSchema = exports.ownerPaginationSchema = exports.adminsPaginationSchema = exports.playerPaginationSchema = void 0;
...
exports.ownerPaginationSchema = joi_1.default.object({
    search: joi_1.default.string().trim().allow('').pattern(/^[a-zA-Z0-9\s]*$/).optional(),
});
exports.auctionPlayerPaginationSchema = joi_1.default.object({
    page: joi_1.default.number().required().min(1),
    search: joi_1.default.string().trim().allow('').pattern(/^[a-zA-Z0-9\s]*$/).required(),
});
